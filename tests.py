...
def test_register_user():
    ...
    print('\nUser Registration API Response:\n ', response.request.url, response.request.method, response.status_code, response.text)
...
def test_generate_token():
    ...
    return {"Authorization": "Bearer {0}".format(json.loads(response.text)['data']['access_token'])}
